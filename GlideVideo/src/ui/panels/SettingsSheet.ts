...
export class SettingsSheet extends UIComponent {
    ...
    public update(): void {
        ...
        this.rememberPlaybackSwitch.setChecked(this.store.settings.rememberPlayback);
        this.scrollCompatibilitySwitch.setChecked(this.store.settings.scrollCompatibility);
    }
}
