...
export class Controller {
	...
	constructor() {
		...
		this.videoTransform = new VideoTransform(
			this.eventBus,
			this.store,
			this.ui,
		);
		...
		// Shadow-root observers discover videos before init; they signal here
	...
	public safeInit() {
		...
		this.lightObserver = new MutationObserver((mutations) => {
			const hasVideo =
				...
				Array.from(this.videoTracker.shadowObservers.keys()).some((root) =>
