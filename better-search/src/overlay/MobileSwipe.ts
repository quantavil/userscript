...
export class MobileSwipe {
    ...
    constructor(store: Store, signal: AbortSignal) {
        this._store = store;
        this._signal = signal;
    ...
    private _initListeners(): void {
        // Only register touch listeners if touch is supported on the device to keep it completely dead on desktop
    ...
    private _animateOpen(item: HTMLElement): void {
