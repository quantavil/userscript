...
function to0x88(pst64: number[]): Int16Array {
...
export const PST_MG: (Int16Array | null)[] = [null, PST_PAWN_MG, PST_KNIGHT_MG, PST_BISHOP_MG, PST_ROOK_MG, PST_QUEEN_MG, PST_KING_MG];
export const PST_EG: (Int16Array | null)[] = [null, PST_PAWN_EG, PST_KNIGHT_EG, PST_BISHOP_EG, PST_ROOK_EG, PST_QUEEN_EG, PST_KING_EG];
