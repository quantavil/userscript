...
import { chessCoordinatesToIndex } from './coordinates.js';
...
export function getRights(boardMatrix) {
    if (!boardMatrix) boardMatrix = getBoardMatrix();
    let rights = '';
    ...
    if (useChess960) {
        ...
        const e1 = getPieceFromMatrix('e1'),
              h1 = getPieceFromMatrix('h1'),
              a1 = getPieceFromMatrix('a1');

        if(e1 == 'K' && h1 == 'R') rights += 'K';
        if(e1 == 'K' && a1 == 'R') rights += 'Q';

        const e8 = getPieceFromMatrix('e8'),
              h8 = getPieceFromMatrix('h8'),
              a8 = getPieceFromMatrix('a8');
